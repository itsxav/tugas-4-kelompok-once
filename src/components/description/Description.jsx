...
const Description = () => {
  return (
    <>
    <div className='relative rounded-xl bg-red-700 flex justify-center mx-2 my-7 border h-32 w-70 md:mx-20 space-x-2 md:space-x-7 lg:space-x-16 lg:mx-32 lg:h-52'>
        <div className='border px-2'>
            <img className='w-36 mx-2 mt-9 md:my-5 lg:my-12 lg:w-48' src="/img/Japan.png" alt="" />
        </div>
        <div className=' w-80 border my-6 px-2 md:my-5 lg:my-10'>

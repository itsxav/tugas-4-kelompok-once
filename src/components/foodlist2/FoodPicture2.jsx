...
const FoodPicture2 = () => {
  return (
    <>
        <div className='flex justify-evenly text-[white] md:mb-6'>
            {feed.map((items, index) => (
                <div className='w-44 text-center bg-red-800 my-3 md:pb-2 space-x-3 mx-3 rounded-lg md:mb-6' key={index}>
